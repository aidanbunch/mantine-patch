...
var SelectItems = require('@mantine/core/cjs/Select/SelectItems/SelectItems.js');
var DefaultItem = require('@mantine/core/cjs/Select/DefaultItem/DefaultItem.js');
var SelectPopover = require('@mantine/core/cjs/Select/SelectPopover/SelectPopover.js');
var SelectScrollArea = require('@mantine/core/cjs/Select/SelectScrollArea/SelectScrollArea.js');
var filterData = require('@mantine/core/cjs/Autocomplete/filter-data/filter-data.js');
var Autocomplete_styles = require('@mantine/core/cjs/Autocomplete/Autocomplete.styles.js');
var useInputProps = require('@mantine/core/cjs/Input/use-input-props.js');
var Input = require('@mantine/core/cjs/Input/Input.js');
    ...
    switch (event.key) {
      ...
      case "Enter": {
        if (filteredData[hovered] && dropdownOpened) {
          ...
          event.preventDefault();
          typeof onSearchQuery === "function" && onSearchQuery();
        }
        break;
      }
      case "Escape": {
